# The Canonical Distribution of Kubernetes - designed for Google Cloud Platform (GCP)
...
### Configuring the GCP Integrator Charm

This bundle file uses the [GCP Integrator Charm]
(https://github.com/juju-solutions/charm-gcp-integrator) which requires custom 
...
This will allow Juju to grant the gcp integrator charm the credentials, instead of
