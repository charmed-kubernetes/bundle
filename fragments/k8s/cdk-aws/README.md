# The Canonical Distribution of Kubernetes - designed for Amazon Web Services (AWS) Public Cloud
...
### Configuring the AWS Integrator Charm

This bundle file uses the [AWS Integrator Charm]
(https://github.com/juju-solutions/charm-aws-integrator) which requires custom 
...
This will allow Juju to grant the AWS integrator charm the credentials, instead of
...
After deployment, you must create a storage class for EBS. Load-balancer creation 
should be automatic, assuming your IAM account has the correct permissions to both 
